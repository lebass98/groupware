...
- **근태일지 GitHub Actions 자동 크롤링 도입**: 매일 오전 9시(KST) 자동 실행 및 연·월 지정 수동 실행 워크플로(`sync-attendance.yml`) 신설, 크롤러의 CI 환경변수(Secrets) 지원 추가, 배포본 설정 화면에서 Actions 수동 실행 링크 안내.
