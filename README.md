...
- **프로젝트 메인 등록 vs 프로젝트 내부 미션 등록 팝업 분기 & 프로젝트 선택창 자동 숨김 처리**:
  - 프로젝트 목록 메인 화면에서 등록 버튼 클릭 시 **'신규 프로젝트 / 업무 등록'** 폼으로 동작하여 프로젝트 선택/직접 입력 필드가 노출됨.
  - 특정 프로젝트 내부 진입 후 등록 버튼 클릭 시 **'프로젝트 내 미션 등록'** 폼으로 전환되며, 해당 프로젝트 소속으로 자동 고정되어 **프로젝트 선택 필드가 화면에서 완전히 숨김(`hidden`) 처리**되도록 명확히 분리 구현.
